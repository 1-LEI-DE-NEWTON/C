...
char *allocEcopyPonteiroFiltroSelecionado(char respostaFiltroSelecionado[])
{
    static char *ponteiroFiltroSelecionado;
    ...
    */
    ...
    ponteiroFiltroSelecionado = realloc(ponteiroFiltroSelecionado, strlen(respostaFiltroSelecionado) + 1);
    //Copia o conteudo da variavel respostaFiltroAsst para a variavel ponteiroFiltroAtivo
    strcpy(ponteiroFiltroSelecionado, respostaFiltroSelecionado);
    return ponteiroFiltroSelecionado;
}
...
int main(int argc, char **argv){
    ...
    {      
        ...
        {                        
            ...
            ponteiroFiltroAtivo = allocEcopyPonteiroFiltroSelecionado(respostaFiltroAsst);
            exibirTopoTabela();
        }
        ...
        if (respostaFiltro == 'q')
        {
            ...
            ponteiroFiltroQuantidade = allocEcopyPonteiroFiltroSelecionado(respostaFiltroQuantidade);
            exibirTopoTabela();
        }
